# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'sale_order/harshak_template.xml',
        'sale_order/harshak_professional_template.xml',
        'sale_order/harshak_professional_template_inherit.xml',
